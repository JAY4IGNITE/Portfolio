      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-stretch">
          ...
          <FadeIn delay={0.1} y={30} className="h-full">
            <div className="relative rounded-[40px] border border-[#D7E2EA]/10 bg-[#111111]/85 p-6 sm:p-8 hover:border-[#B600A8]/30 transition-all duration-300 group hover:shadow-[0_15px_40px_rgba(182,0,168,0.05)] overflow-hidden h-full flex flex-col justify-between">
              <div>
          ...
          <FadeIn delay={0.2} y={30} className="h-full">
            <div className="relative rounded-[40px] border border-[#D7E2EA]/10 bg-[#111111]/85 p-6 sm:p-8 hover:border-[#D5A020]/30 transition-all duration-300 group hover:shadow-[0_15px_40px_rgba(213,160,32,0.05)] overflow-hidden h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between gap-4 mb-8">
                  <div className="flex items-center gap-4">
                    <a
                ...
                <div className="grid grid-cols-3 gap-3 my-6">
                  <div className="bg-black/35 rounded-2xl p-4 text-center border border-[#D7E2EA]/5">
                    ...
                    {isCcLoading ? (
                      ...
                      <span className="text-lg sm:text-xl font-bold text-[#D5A020]">
                        <CountUp target={ccStats.rating || 0} delay={0.3} />
                      </span>
                    )}
                  </div>
                  <div className="bg-black/35 rounded-2xl p-4 text-center border border-[#D7E2EA]/5">
                  ...
                  <div className="bg-black/35 rounded-2xl p-4 text-center border border-[#D7E2EA]/5">
                    ...
                    {isCcLoading ? (
                      ...
                      <span className="text-lg sm:text-xl font-bold text-[#BE4C00]">
                        {ccStats.rating ? (ccStats.rating >= 2000 ? 'Div 1' : ccStats.rating >= 1600 ? 'Div 2' : ccStats.rating >= 1400 ? 'Div 3' : 'Div 4') : 'Div 4'}
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div className="space-y-4 text-sm mt-2">
                <div className="flex justify-between items-center py-2 border-b border-[#D7E2EA]/5">
                  <span className="flex items-center gap-2 text-[#D7E2EA]/50 font-light">
                    <Trophy className="w-4 h-4 text-[#D5A020]" /> Current Rating
                  </span>
                  {isCcLoading ? (
                    <div className="h-4 w-12 bg-[#D7E2EA]/10 rounded animate-pulse" />
                  ) : (
                ...
                <div className="flex justify-between items-center py-2 border-b border-[#D7E2EA]/5">
                  <span className="flex items-center gap-2 text-[#D7E2EA]/50 font-light">
                    <Flame className="w-4 h-4 text-[#D5A020]" /> Star Tier
                  </span>
                  {isCcLoading ? (
                    <div className="h-4 w-12 bg-[#D7E2EA]/10 rounded animate-pulse" />
                  ) : (
                    <strong className="font-semibold text-[#D5A020] tracking-wider">
                      {ccStats.stars ? `${ccStats.stars} Coder` : '1★ Coder'}
                    </strong>
                  )}
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="flex items-center gap-2 text-[#D7E2EA]/50 font-light">
                    <Target className="w-4 h-4 text-[#D5A020]" /> Contest League
                  </span>
                  {isCcLoading ? (
                    <div className="h-4 w-16 bg-[#D7E2EA]/10 rounded animate-pulse" />
                  ) : (
                    <strong className="font-semibold text-[#D7E2EA]">
                      {ccStats.rating ? (ccStats.rating >= 2000 ? 'Division 1' : ccStats.rating >= 1600 ? 'Division 2' : ccStats.rating >= 1400 ? 'Division 3' : 'Division 4') : 'Division 4'}
                    </strong>
                  )}
                </div>
              </div>
