import type { GradientCarouselItem } from '@/components/GradientCarousel';
...
export const certificationsData: GradientCarouselItem[] = [
  ...
  // ─── 15. Database Foundations - Oracle Academy ───
  {
  ...
  // ─── 17. Quantum Computing For Everyone ───
  {
    id: 'coursera-quantum',
  ...
  // ─── 20. Infosys Programming Using C++ ───
  {
